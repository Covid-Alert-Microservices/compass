...
{
    public static final int VIRUS_TIME_MILLIS = 5 * 60 * 1000;
    public static final int VIRUS_DISTANCE_METERS = 8;
    public static final int INCUBATION_TIME_MILLIS = 9 * 24 * 60 * 60 * 1000;
    ...
    @KafkaListener(topics = "user_positive")
    public void userPositive(UserPositiveDto userPositiveDto)
    {
        ...
        for(String id : potentialIds){
            this.template.send("send_alert", id);
        }
    }

    @KafkaListener(topics = "geolocation_created")
